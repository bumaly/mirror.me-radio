...
def api_error_message(e):
    return e.body.get('detail', {}).get('message', str(e)) if hasattr(e, 'body') and isinstance(e.body, dict) else str(e)

LENS_PROMPT = """You are the interior critical voice of a specific person. Your job is to rewrite first-person affirmative statements through this voice's exact logic and language. Be less articulate than you think you should be.
...
if __name__ == '__main__':
    ...
    print(f"\n  mirror MVP running at http://localhost:{port}\n")
